<?php
    ...
    while ($line=fgets($file,1024)) {
		...
		$pen['force'],
                 $created,
                 $lastlogin,
                 $item['portable fision generator'],
                 $item['planetary citizenship papers'],
                 $item['pazaak deck'],
                 $item['stormtrooper blaster rifle'],
                 $item['flight helmet'],
                 $item['flight suit'],
                 $item['vibroaxe'],
                 $item['personal shield generator'],
                 $item['X-34 landspeeder'],
                 $item['corellian light freighter'],
                 $alignment,
            ) = explode("\t",trim($line));
            $found=1;
            break;
